...
export type { VirtualListInst, // deprecated, should use v prefix
VirtualListInst as VVirtualListInst, VirtualListScrollTo, VirtualListScrollOptions, VirtualListItemData } from './virtual-list/src';
